...
public class PriceServiceTestIT {
    ...
    public void getAllByDateNone(){
        PriceDTO result = priceService.getByDate(TEST_DATE, TEST_PRODUCT, TEST_BRAND);
    ...
    @Test
    public void test_1(){
        PriceDTO result = priceService.getByDate(TEST_DATE_1, TEST_PRODUCT, TEST_BRAND);
    ...
    @Test
    public void test_2(){
        PriceDTO result = priceService.getByDate(TEST_DATE_2, TEST_PRODUCT, TEST_BRAND);
        Assert.notNull(result);
    ...
    @Test
    public void test_3(){
        PriceDTO result = priceService.getByDate(TEST_DATE_3, TEST_PRODUCT, TEST_BRAND);
        Assert.notNull(result);
        Assert.isTrue(result.getPrice() == 35.50D);
    }
    ...
    @Test
    public void test_4(){
        PriceDTO result = priceService.getByDate(TEST_DATE_4, TEST_PRODUCT, TEST_BRAND);
        Assert.notNull(result);
    ...
    @Test
    public void test_5(){
        PriceDTO result = priceService.getByDate(TEST_DATE_5, TEST_PRODUCT, TEST_BRAND);
        Assert.notNull(result);
